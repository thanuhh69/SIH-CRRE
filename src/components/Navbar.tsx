    ...
    <header className="w-full bg-white z-50 shadow-sm border-b border-slate-200">
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
        <Link href="/" className="flex items-center gap-3.5 group">
          ...
          <div className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-slate-900 flex items-center justify-center border-2 border-college-gold shadow-md shrink-0 overflow-hidden group-hover:scale-105 transition-transform">
            <img
